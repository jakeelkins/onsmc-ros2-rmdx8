...
public:
    ...
    Commander():Node("commander"){
        ...
        subscription_ = this->create_subscription<onsmc_servo::msg::Control>(
...
private:
    ...
    rclcpp::Subscription<onsmc_servo::msg::Control>::SharedPtr subscription_;

    // -- Commander ICs --
    float u = 0.0f;

    void control_receive_callback(const onsmc_servo::msg::Control &control_msg){
